...
class ReleaseNoteCompiler:
    ...
    :param str pull_request_url: GitHub API URL for the pull request - this can be accessed in a GitHub workflow as ${{ github.event.pull_request.url }}
    ...
    def compile_release_notes(self):
        ...
        * If the autogeneration indicators are not present, the new autogenerated release notes are added after the
        ...
        :return str:
        """
        if SKIP_INDICATOR in self.previous_notes:
